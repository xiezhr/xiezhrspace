...
![VSCode 集成终端运行 Claude Code](./assets/vscode-terminal.png)
...
![VSCode 文件变更标记](./assets/vscode-diff.png)
...
![Cursor 终端运行 Claude Code](./assets/cursor-terminal.png)
