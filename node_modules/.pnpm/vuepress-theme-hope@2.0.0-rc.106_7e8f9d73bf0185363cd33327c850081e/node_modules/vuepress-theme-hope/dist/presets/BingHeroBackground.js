...
//#region src/presets/BingHeroBackground.ts
const bingStorage = useStorage("bing-image", {
	index: 0,
	data: []
});
var BingHeroBackground_default = defineComponent({
	...
	setup() {
		...
		return () => {
			...
			return h(ClientOnly, () => url ? [h("div", {
				...
				h(Transition, { name: "fade-in" }, () => showInfo.value ? h("div", {
					class: "bing-info",
					ref: bingInfo
				}, [
					h("a", {
				...
				h("div", { class: "bing-location" }, [h("span", { class: "bing-location-icon" }), title]),
				h("button", {
...
//#endregion
export { BingHeroBackground_default as default };
